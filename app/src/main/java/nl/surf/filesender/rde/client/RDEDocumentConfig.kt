...
object RDEDocumentConfig {
    ...
    const val SFI_ENABLED = false
    const val DG_ID_FOR_RDE = PassportService.EF_DG14.toInt() // The datagroup to use for RDE, probably you want DG14 because it does not contain privacy sensitive data
}